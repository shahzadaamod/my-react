...
import SliderTitleComponent from "../../components/SliderTitleComponent";
  ...
  return (
    <main className="content">
      <section
        ...
        id="block-views-block-new-home-slider-block-1"
      >
        <div>
                  ...
                  <div className="inner-banner">
                    <div className="slideWrap">
                      <div className="views-row slideFirstShow">
                        <img
                          alt="Avasant Recognition"
                          src="https://aamodfinserv.in/techintegrants/assets/images/slider1.png"
                        />
                        <div className="banner-content">
                          <div className="container">
                            <h1>
                              Kellton features in Avasant's SAP S/4HANA Services
                              2023-2024 Radarview<sup>TM</sup>
                            </h1>
                            <p
                            ...
                            <p>
                              <a
                                className="site-btn blue"
                                href="/news-announcement/kellton-recognized-as-challenger-in-avasant-sap-s4hana-services-report"
                                tabIndex="0"
                              >
                                Read More
                              </a>
      ...
      <section className="brand_view_block new-home-brand">
        <div className="container">
          <div
            className="views-element-container"
            id="block-views-block-show-brands-block-6"
          >
      ...
      <section className="blogs-and-resoucrecs new-home-insights">
        <div className="container">
          <div
            className="views-element-container"
            id="block-views-block-home-page-section-block-5"
          >
            <div>
          ...
          <div className="main">
            <div className="right-container">
              <div className="slick-initialized slick-slider">
                ...
                >
                  <img
                    src="https://d1ugv6dopk5bx0.cloudfront.net/s3fs-public/Vector%20959.png"
                    alt=""
                    loading="lazy"
                    width="16px"
                    height="16px"
                    ...
                    {blogData.map((blog, index) => (
                      <div key={index} className="blog-content-block">
                        ...
                        <div className="blog-content-desc">
                          ...
                          <h5 className="type-tit">
                            <a href={blog.link} tabIndex="0">
                              {blog.title}
                            </a>
                          </h5>
